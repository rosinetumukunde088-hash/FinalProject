...
import { FiUser, FiMail, FiPhone, FiShield, FiClock, FiLock, FiEye, FiEyeOff, FiCheck, FiX } from 'react-icons/fi';
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-2xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <span className="inline-block mt-1 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-purple-100 text-purple-700">
                Admin
              </span>
            </div>
          </div>
        ...
        <div className="mt-6 space-y-3 border-t border-gray-100 pt-6">
          ...
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
            ...
            <div><p className="text-xs text-gray-500 uppercase tracking-wide">Role</p><p className="font-medium text-gray-900">Administrator</p></div>
          </div>
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
        ...
        <div className="mt-6 pt-6 border-t border-gray-100">
          <div className="flex items-center justify-between">
            <h2 className="text-base font-bold text-gray-900 flex items-center space-x-2">
              <FiLock className="text-purple-500" /><span>Change Password</span>
            </h2>
            {!changingPassword && (
              <button onClick={openPasswordForm} className="text-sm font-medium text-purple-600 hover:text-purple-700 hover:underline">
                Change Password
              </button>
            )}
          </div>
