  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Manage your trader account details</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-2xl">
        ...
        <div className="mt-6 space-y-3 border-t border-gray-100 pt-6">
          ...
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
            ...
            <div><p className="text-xs text-gray-500 uppercase tracking-wide">Role</p><p className="font-medium text-gray-900">Trader</p></div>
          </div>
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
        ...
        <div className="mt-6 pt-6 border-t border-gray-100">
          <div className="flex items-center justify-between">
            <h2 className="text-base font-bold text-gray-900 flex items-center space-x-2">
              <FiLock className="text-blue-500" /><span>Change Password</span>
            </h2>
            {!changingPassword && (
              <button onClick={openPasswordForm} className="text-sm font-medium text-blue-600 hover:text-blue-700 hover:underline">
                Change Password
              </button>
            )}
          </div>
